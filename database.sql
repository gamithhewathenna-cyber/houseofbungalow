...
('brunch_subheading','Slow Mornings. Bottomless Brunch. Good Company.','brunch_page','Subheading','text',3),
('brunch_lede1','Saturday and Sunday, the House slows down.','brunch_page','Lede line 1','text',4),
('brunch_lede2','Brunch, bottomless drinks and a room that eases into the weekend.','brunch_page','Lede line 2','text',5),
('brunch_p1','From sweet to savoury, brunch classics to bottomless cocktails — pull up a seat and let the weekend take over.','brunch_page','Paragraph','textarea',6),
('brunch_hours','**Saturday & Sunday:** 11:00 AM – 3:00 PM','brunch_page','Hours line (use **word** for bold)','text',7),
('brunch_btn1_label','BOOK BRUNCH','brunch_page','Button 1 label','text',8),
('brunch_btn1_url','#','brunch_page','Button 1 URL','text',9),
('brunch_btn2_label','VIEW MENU','brunch_page','Button 2 label','text',10),
